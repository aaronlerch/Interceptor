...
interceptor type e3 --secret op://<vault>/<item>/<field>   # Type a 1Password credential by reference; the value never leaves the daemoninterceptor select e7 "option-value"         # Select dropdown option
